...
function initializeOwl() {
    if ($(".owl-carousel").length) {
        $(".owl-carousel").each(function() {
            ...
            var id = $(this).attr("id");
            var items = parseInt($(this).attr("data-owl-items"), 10) || 1;
            var nav = parseInt($(this).attr("data-owl-nav"), 2) || 0;
            var dots = parseInt($(this).attr("data-owl-dots"), 2) || 0;
            var center = parseInt($(this).attr("data-owl-center"), 2) || 0;
            var loop = parseInt($(this).attr("data-owl-loop"), 2) || 0;
            var margin = parseInt($(this).attr("data-owl-margin"), 2) || 0;
            var autoWidth = parseInt($(this).attr("data-owl-auto-width"), 2) || 0;
            var navContainer = $(this).attr("data-owl-nav-container") || 0;
            var autoplay = $(this).attr("data-owl-autoplay") || 0;
            var fadeOut = $(this).attr("data-owl-fadeout") || 0;
            ...
            if (id === "carouselCursos" || id === "carouselEquipe" || id === "carouselBlog") {
                responsiveConfig = {
                    0: {
                        items: 1
                    },
            ...
            $(this).owlCarousel({
                ...
                animateOut: fadeOut ? "fadeOut" : false,
                autoplaySpeed: 1000, // Ajuste da velocidade de autoplay
                autoplay: autoplay,
                autoHeight: false,
                autoWidth: autoWidth,
                items: items,
                ...
                nav: nav,
                dots: dots,
                navText: [""], // Ajuste as setas conforme necessário
                smartSpeed: 600, // Velocidade da transição
                fluidSpeed: 600, // Animação mais fluida
                dragEndSpeed: 600, // Velocidade do final do arrasto
                responsive: responsiveConfig,
                onDrag: function(event) {
                    $(this).find('.owl-stage').css('transition', 'none');
                },
                onDragged: function(event) {
                    $(this).find('.owl-stage').css('transition', 'transform 0.6s ease');
                },
...
// Inicializa o carrossel após o documento estar pronto
$(document).ready(function() {
    initializeOwl();
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Função para verificar o cookie de consentimento
    ...
    document.getElementById('accept-cookies').addEventListener('click', function() {
        setCookie("cookie_consent", "accepted", 0.0007); // Expira em aproximadamente 1 minuto
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var isAuthenticated = true; // Substitua por sua lógica de autenticação
    ...
    if (isAuthenticated) {
        ...
        }, 100); // Atraso para suavizar a transição
    }
});
