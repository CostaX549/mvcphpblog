    ...
    <header id="page-header">
        <nav class="navigation background-is-dark">
            <div class="container">
                <div class="wrapper">
                    <div class="left">
                        <a href="/mvcphpblog/" class="brand"><img src="assets/img/logo.png" alt=""></a>
                    </div>
                    <!--end left-->
                    <div class="right">
        ...
        <div class="hero-section background-is-dark blog-title">
            <div class="wrapper">
                <div class="hero-title">
                    <div class="container">
                        <h1 class="animate">Welcome to Our Blog</h1>
                    </div>
                    <!--end container-->
                </div>
                <!--end hero-title-->
                    ...
                    <div class="col-md-9 col-sm-9">
                        <section id="content">
                            <article class="blog-post">
                                <a href="blog-detail.html"><img src="assets/img/gallery-big-03.jpg" alt=""></a>
                            ...
                            <article class="blog-post">
                                ...
                                <iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/38403328&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>
                                <figure class="meta">
                                    <a href="#" class="link icon"><i class="fa fa-user"></i>Admin</a>
                                    <a href="#" class="link icon"><i class="fa fa-calendar"></i>06/04/2014</a>
                                    <div class="tags">
                ...
                <div class="left">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade in active" id="modal-floor-plan-1">
                            <a href="assets/img/floor-plan.jpg" class="image-popup"><img src="assets/img/floor-plan.jpg" alt=""></a>
